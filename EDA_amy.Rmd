...
Thus the correlation amoing subunits within a cluster equals $\rho = \frac{\sigma^2_b}{\sigma^2}$. This correlation is the same accross all subunits and is called the compoind symmetry model in the repeated measures context. 
